...
test('home page supports the mobile-first timeline flow', async ({ page }, testInfo) => {
  await page.goto('/');
  await captureFlowScreenshot(page, testInfo, 'home-initial');
  ...
  await captureFlowScreenshot(page, testInfo, 'home-create-timeline-modal');
